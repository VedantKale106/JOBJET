...
public class StudentBook extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CustomBaseAdapter customBaseAdapter = new CustomBaseAdapter(StudentBook.this,names , images,rates);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(StudentBook.this , StudentInfo.class);
...
//    public void insert(String namef , int agef , int ratef , String skillf,String locationf,  String descf , int imagef )
//    {
//        count++;
//        names[count]=namef;
//        age[count]=agef;
//        rates[count]=ratef;
//        skills[count]=skillf;
//        location[count]=locationf;
//        Description[count]=descf;
//        images[count]=imagef;
//    }
}